...
![같은 이벤트 계약의 인메모리 버스와 NATS JetStream 처리량 비교](images/posts/04-event-bus-benchmark.png)

인메모리는 82,088 ev/s, JetStream 은 2,674 ev/s — 약 30배를 내주고 디스크 내구성과 재전송을 샀습니다. 이 트레이드오프를 알고 쓰는 것과 모르고 쓰는 것은 장애 때 다른 결과를 만듭니다.
